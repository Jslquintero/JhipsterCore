...
using Scrutor;
using JhipsterCore.Domain.Entities;
using JhipsterCore.Domain.Repositories.Interfaces;
using JhipsterCore.Infrastructure.Data.Repositories;

namespace JhipsterCore.Configuration;
...
public static class RepositoryStartup
{
    public static IServiceCollection AddRepositoryModule(this IServiceCollection services)
    {
        ...
        services.Scan(scan => scan
            ...
            .AddClasses(classes => classes.InNamespaces("JhipsterCore.Infrastructure.Data.Repositories"))
            ...
            .AddClasses(classes => classes.Where(type => type.Namespace.Equals("JhipsterCore.Infrastructure.Data.Repositories") &&
